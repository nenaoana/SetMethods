           ...
           outcome)
  {
    ...
    CTE <- list(
      'S1S2Y'=list('Intersection'='Robust Typical Cases (IS*MIN_TS and Y > 0.5)',
                   ...
                   'CaseTypes'= if(sum((ND$'S1*S2'>0.5)&(ND$'Outcome' >0.5)) == 0) {'No cases in this intersection'} 
      ...
      's1S2Y'=list('Intersection'='Possible Typical Cases (~IS*MAX_TS and Y > 0.5)',
                   ...
                   'CaseTypes'= if(sum((ND$'s1*S3'>0.5)&(ND$'Outcome' >0.5)) == 0) {'No cases in this intersection'} 
